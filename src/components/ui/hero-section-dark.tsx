  ...
  (
    ...
    return (
      <div className={cn("relative", className)} ref={ref} {...props}>
        <div className="absolute top-0 z-[0] h-screen w-screen bg-[#131445] dark:bg-[#131445] bg-[radial-gradient(ellipse_40%_70%_at_35%_-10%,rgba(111,120,255,0.45),rgba(19,20,69,0)),radial-gradient(ellipse_40%_60%_at_80%_-20%,rgba(189,143,255,0.3),rgba(19,20,69,0))] dark:bg-[radial-gradient(ellipse_40%_70%_at_35%_-10%,rgba(111,120,255,0.55),rgba(19,20,69,0)),radial-gradient(ellipse_40%_60%_at_80%_-20%,rgba(189,143,255,0.4),rgba(19,20,69,0))]" />
